...
public class FilmRegistryModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ppv ppv = FilmRegistryProveedor.readRecord(getContentResolver(), ppvId);
    ...
    void attempSave(){
        ...
        FilmRegistryProveedor.updateRecord(getContentResolver(),ppv);
